...
android {
    ...
    defaultConfig {
        ...
        minSdk = 24
        targetSdk = 37
        versionCode = 217020008
        versionName = "2.17.00-beta01"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
