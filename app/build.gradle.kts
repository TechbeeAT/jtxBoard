...
android {
    ...
    defaultConfig {
        ...
        minSdk = 24
        targetSdk = 36
        versionCode = 216000013
        versionName = "2.16.00-beta03"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
