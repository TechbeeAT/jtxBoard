...
android {
    ...
    defaultConfig {
        ...
        minSdk = 23
        targetSdk = 36
        versionCode = 215020002
        versionName = "2.15.02-alpha02"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
