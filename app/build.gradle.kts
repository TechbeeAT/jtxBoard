...
android {
    ...
    defaultConfig {
        ...
        minSdk = 24
        targetSdk = 37
        versionCode = 217030002
        versionName = "2.17.03-beta01"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
