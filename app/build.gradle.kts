...
android {
    ...
    defaultConfig {
        ...
        minSdk = 24
        targetSdk = 37
        versionCode = 217020005
        versionName = "2.17.00-alpha05"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
