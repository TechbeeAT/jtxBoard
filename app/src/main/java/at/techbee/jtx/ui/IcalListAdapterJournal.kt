...
class IcalListAdapterJournal(var context: Context, var model: IcalListViewModel) :
    ...
    private fun addSubtasksView(subtask: ICal4List?, holder: JournalItemHolder) {
    ...
    private fun addAttachmentView(attachments: List<Attachment>?, holder: JournalItemHolder) {
