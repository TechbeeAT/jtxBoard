...
abstract class IcalListAdapter(var context: Context, var model: IcalListViewModel) :
 ...
 */
    ...
    private fun addSubtasksView(subtask: ICal4List?, subtasksLinearLayout: LinearLayout) {
    ...
    private fun addAttachmentView(attachments: List<Attachment>?, attachmentsLinearLayout: LinearLayout) {
