...
fun DetailsCardLocation(
    ...
    var isLocationTextFieldFocused by remember { mutableStateOf(false) }
    ...
    ElevatedCard(
        ...
        Column(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    BasicTextField(
                        ...
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(vertical = if(isLocationTextFieldFocused || location.isNotBlank()) 8.dp else 4.dp)
                            .focusRequester(focusRequester)
                            .onFocusChanged { focusState ->
                                isLocationTextFieldFocused = focusState.hasFocus
                            }
                    )
            ...
            Column {
                AnimatedVisibility (isLocationTextFieldFocused && (allLocations.isNotEmpty() || allLocalAddresses.isNotEmpty())) {
                    LazyRow(
                                ...
                                label = {
                                    val displayString =
                                        if (locationLatLng.geoLat != null && locationLatLng.geoLong != null)
                                            "${locationLatLng.location} (${UiUtil.doubleTo5DecimalString(locationLatLng.geoLat)},${UiUtil.doubleTo5DecimalString(locationLatLng.geoLong)})"
                                        else
            ...
            AnimatedVisibility(geoLat != null && geoLong != null && !LocalInspectionMode.current) {
                MapComposable(
                    initialLocation = location,
                    initialGeoLat = geoLat,
                    initialGeoLong = geoLong,
...
@Preview(showBackground = true)
@Composable
fun DetailsCardLocation_Preview_readonly() {
    MaterialTheme {
        DetailsCardLocation(
            initialLocation = "Vienna, Stephansplatz",
            initialGeoLat = null,
...
@Preview(showBackground = true)
@Composable
fun DetailsCardLocation_Preview_readonly_with_geo() {
    MaterialTheme {
        DetailsCardLocation(
            initialLocation = "Vienna, Stephansplatz",
            initialGeoLat = 23.447378,
